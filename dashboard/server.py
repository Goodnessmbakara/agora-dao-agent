...
Simple mode with demo data (live mode requires additional setup)
"""
...
class AgoraDashboardHandler(http.server.SimpleHTTPRequestHandler):
    ...
    def serve_api_proposals(self):
        """Serve proposal data - currently demo data
        
        Note: Connect to live Solana RPC by uncommenting the imports above
        and implementing the live data fetching logic
        """
        ...
        response = {
            ...
            "source": "demo",
            "note": "Demo data - real Solana integration available in agora_live.py"
        }
...
def start_dashboard(port=8080, open_browser=True):
    ...
    print("=" * 40)
    print("📋 Serving demo data for visualization")
    print("💡 Real Solana monitoring: python3 agora_live.py --scan")
